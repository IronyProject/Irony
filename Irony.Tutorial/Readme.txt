...
1. Grammar basics. Arithmetic expressions - single-line arithmetic expressions (NumberLiteral).
   Operator precedence, associativity.
2. Evaluation. Irony runtime classes; defining built-in functions. 
3. Variables - identifier terminal. Assignments, multi-line statements. Using MakeStarRule(), MakePlusRule methods. 
