...
namespace Irony.Ast.Interpreter {
  ...
  public partial class LanguageRuntime {
    ...
    public readonly DynamicCallDispatcher Dispatcher;
    ...
    public LanguageRuntime() {
      Dispatcher =  new DynamicCallDispatcher(this);
      Init();
    }
    ...
    #region Dispatching
    public virtual DispatchRecord CreateDispatchRecord(DynamicCallDispatcher dispatcher, DispatchKey forKey) {
/*      Type commonType = GetCommonType(dispatcher.MethodName, forKey.Arg1Type, forKey.Arg2Type);
      ...
      DispatchKey baseKey = new DispatchKey(commonType, commonType);
 ...
 */
    ...
    public virtual bool HandleOverflow(Exception ex, DynamicCallDispatcher dispatcher, DispatchRecord failedRecord, EvaluationContext context) {
    ...
    public virtual bool HandleException(Exception ex, DynamicCallDispatcher dispatcher, DispatchRecord failedTarget, EvaluationContext context) {
      return false;
    }
    #endregion
    ...
    protected virtual TypeConverter GetConverter(Type fromType, Type toType) {
      ...
      DispatchKey key = DispatchKey.CreateFromTypes("##convert##", fromType, toType);
