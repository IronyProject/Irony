...
namespace Irony.Ast.Interpreter {
  ...
  public partial class LanguageRuntime {
    ...
    private void AddRecord(string op, Type type, BinaryCallTarget target) {
    }
    private void AddRecord(string op, Type type, BinaryCallTarget target, TypeConverter typeConverter) {
    }
    ...
    public virtual void InitOperatorImplementations() {
      ...
      op = "+";
      AddRecord(op, typeof(sbyte), (x, y) => (sbyte)x + (sbyte)y);
      AddRecord(op, typeof(byte), (x, y) => (byte)x + (byte)y);
      AddRecord(op, typeof(Int16), (x, y) => (Int16)x + (Int16)y);
      AddRecord(op, typeof(UInt16), (x, y) => (UInt16)x + (UInt16)y);
      AddRecord(op, typeof(Int32), (x, y) => checked((Int32)x + (Int32)y));
      AddRecord(op, typeof(UInt32), (x, y) => checked((UInt32)x + (UInt32)y));
      AddRecord(op, typeof(Int64), (x, y) => checked((Int64)x + (Int64)y));
      AddRecord(op, typeof(UInt64), (x, y) => checked((UInt64)x + (UInt64)y));
      AddRecord(op, typeof(Single), (x, y) => (Single)x + (Single)y);
      AddRecord(op, typeof(double), (x, y) => (double)x + (double)y);
      AddRecord(op, typeof(BigInteger), (x, y) => (BigInteger)x + (BigInteger)y);
      AddRecord(op, typeof(Complex), (x, y) => (Complex)x + (Complex)y);
      AddRecord(op, typeof(string), (x, y) => (string)x + (string)y);
      ...
      AddRecord(op, typeof(sbyte), (x, y) => (sbyte)x * (sbyte)y);
      AddRecord(op, typeof(byte), (x, y) => (byte)x * (byte)y);
      AddRecord(op, typeof(Int16), (x, y) => checked((Int16)x * (Int16)y));
      AddRecord(op, typeof(UInt16), (x, y) => checked((UInt16)x * (UInt16)y));
      AddRecord(op, typeof(Int32), (x, y) => checked((Int32)x * (Int32)y));
      AddRecord(op, typeof(UInt32), (x, y) => checked((UInt32)x * (UInt32)y));
      AddRecord(op, typeof(Int64), (x, y) => checked((Int64)x * (Int64)y));
      AddRecord(op, typeof(UInt64), (x, y) => checked((UInt64)x * (UInt64)y));
      ...
      op = "&";
      AddRecord(op, typeof(bool), (x, y) => (bool)x & (bool)y);
      AddRecord(op, typeof(sbyte), (x, y) => (sbyte)x & (sbyte)y);
      AddRecord(op, typeof(byte), (x, y) => (byte)x & (byte)y);
      AddRecord(op, typeof(Int16), (x, y) => (Int16)x & (Int16)y);
      AddRecord(op, typeof(UInt16), (x, y) => (UInt16)x & (UInt16)y);
      AddRecord(op, typeof(Int32), (x, y) => (Int32)x & (Int32)y);
      AddRecord(op, typeof(UInt32), (x, y) => (UInt32)x & (UInt32)y);
      AddRecord(op, typeof(Int64), (x, y) => (Int64)x & (Int64)y);
      AddRecord(op, typeof(UInt64), (x, y) => (UInt64)x & (UInt64)y);
      ...
      op = "<";
      AddRecord(op, typeof(sbyte), (x, y) => (sbyte)x < (sbyte)y, BoolResultConverter);
      AddRecord(op, typeof(byte), (x, y) => (byte)x < (byte)y, BoolResultConverter);
      AddRecord(op, typeof(Int16), (x, y) => (Int16)x < (Int16)y, BoolResultConverter);
      AddRecord(op, typeof(UInt16), (x, y) => (UInt16)x < (UInt16)y, BoolResultConverter);
      AddRecord(op, typeof(Int32), (x, y) => checked((Int32)x < (Int32)y), BoolResultConverter);
      AddRecord(op, typeof(UInt32), (x, y) => checked((UInt32)x < (UInt32)y), BoolResultConverter);
      AddRecord(op, typeof(Int64), (x, y) => checked((Int64)x < (Int64)y), BoolResultConverter);
      AddRecord(op, typeof(UInt64), (x, y) => checked((UInt64)x < (UInt64)y), BoolResultConverter);
      AddRecord(op, typeof(Single), (x, y) => (Single)x < (Single)y, BoolResultConverter);
      AddRecord(op, typeof(double), (x, y) => (double)x < (double)y, BoolResultConverter);
      AddRecord(op, typeof(BigInteger), (x, y) => (BigInteger)x < (BigInteger)y, BoolResultConverter);
