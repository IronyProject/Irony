...
namespace Refal.UnitTests
{
  ...
  /// <summary>
  /// Refal interpreter tests.
  /// Written by Alexey Yakovlev, yallie@yandex.ru.
  /// http://refal.codeplex.com
  /// </summary>
  [TestClass]
  public class RefalInterpreterTests
  {
    /// <summary>
    ...
    void RunSampleAndCompareResults(string programResourceName, string outputResourceName, IConsoleAdapter console = null)
    {
      ...
      Assert.AreEqual(NormalizeNewLines(LoadResourceText(outputResourceName)), NormalizeNewLines(result));
    }
